...
- MoonBit official member [myfreess NSlash951](https://github.com/myfreess) developed a Unicode CaseFold library [casefold](https://github.com/myfreess/casefold) for MoonBit, which can perform fuzzy matching of Unicode.
