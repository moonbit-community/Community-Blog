...
MODEL_NAME = "deepseek-ai/DeepSeek-V3"  # 使用最强的 DeepSeek-V3

# API 请求参数
TEMPERATURE = 0.1        # 低温度保证分类稳定
MAX_TOKENS = 1500        # DeepSeek-V3 输出长度
TOP_P = 0.7             
TOP_K = 50              
...
# README 抓取
README_MAX_CHARS_FOR_AI = 2000      # 喂给 AI 的 README 长度
README_MAX_CHARS_FOR_OUTPUT = 500   # 输出展示的 README 长度

# 代码抓取
MBT_FILE_MAX_CHARS = 300            # 单个.mbt 文件抓取长度
MAX_MBT_FILES = 10                  # 最多抓取的.mbt 文件数

# ============ 并发与 AI 配置 ============

MAX_CONCURRENCY = 6  # 最大并发数
AI_TIMEOUT = 60      # AI 请求超时（秒）
AI_RETRIES = 2       # AI 请求重试次数
